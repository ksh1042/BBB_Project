...
public interface UnitworkService {
	...
	public void updateUDD(List<UnitworkVO> updateList, List<UnitworkVO> createList, List<Integer> removeList, UnitworkHistVO hist, ProjectVO project) throws SQLException;
