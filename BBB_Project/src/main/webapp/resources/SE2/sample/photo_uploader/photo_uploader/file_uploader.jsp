		...
		for(FileItem item : items) {
			if(item.getFieldName().equals("callback")) {
				...
				if(item.getSize() > 0) {
					...
					// 파일 기본경로
					String defaultPath = request.getServletContext().getRealPath("/resources");
...
//					}
					...
					///////////////// 서버에 파일쓰기 /////////////////
					return3 += "&bNewLine=true&sFileName="+name+"&sFileURL="+request.getContextPath()+"/resources/upload/"+realname;
				} else {
