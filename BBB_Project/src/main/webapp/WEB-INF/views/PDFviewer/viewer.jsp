...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/web/viewer.css">


<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="<%=request.getContextPath()%>/resources/web/locale/locale.properties">
<script src="<%=request.getContextPath()%>/resources/build/pdf.js"></script>


    <script src="<%=request.getContextPath()%>/resources/web/viewer.js"></script>
