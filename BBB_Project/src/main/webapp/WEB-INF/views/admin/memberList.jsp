					...
					<table class="table table-bordered">
						...
						<c:forEach var="member" items="${memberList }" varStatus="status">
							...
							<tr>
								...
								<td style="text-align: center"; width="200px">${member.id}</td>
								<td style="text-align: center"; width="200px">${member.name}</td>
								<td style="text-align: center";>${member.email}</td>
								
								<td style="text-align: center";width="400px"><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${member.indate}" /></td>
