...
.textAlign {
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="<%=request.getContextPath()%>/project/issue/list">이슈리스트</a></li>
		</ol>
	</section>
				...
				<div class="box">
						...
						<div class="box-tools">
							<div class="input-group input-group-sm">
								<form action="list" style="width: 300px;">
									...
									<div class="input-group input-group-sm"
										style="width: 150px; position: absolute; right: 0; top: 0;">
										<input type="text" name="keyword"
											class="form-control pull-right"
											value="${pageMaker.cri.keyword }" placeholder="Search">
					...
					<div class="box-body">
						<table class="table table-bordered" style="text-align: center;">
							...
							<c:if test="${empty listIssue }">
								<tr>
									<td style="text-align: center;" colspan="5">등록된 이슈가 존재하지
										않습니다.</td>
								</tr>
							</c:if>
						</table>
					...
					<div class="box-footer clearfix">
						...
						<div style="float: right; margin-right: 10px;">
							<button id='newBtn' class="btn btn-primary"
								onclick="registerIssue_go()">이슈 등록</button>
						</div>
						<br />
						<c:if test="${!empty listIssue }">
