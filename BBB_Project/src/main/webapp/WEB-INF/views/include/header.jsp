	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="/main/" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>P</b>MS</span> <!-- logo for regular state and mobile devices -->
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<!-- Menu toggle button --> <a href="#" onclick="postbox_go();">
								<!-- class="dropdown-toggle" data-toggle="dropdown" --> <script>
									function postbox_go() {
								...
								</script> <i class="fa fa-envelope-o"></i> <span
						...
						<li class="dropdown user user-menu">
							...
							data-toggle="dropdown"> <!-- The user image in the navbar-->
								...
								<!-- 접속한 사람의 아이디 혹은 이름 노출 --> <span class="hidden-xs">Alexander
									Pierce</span>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<form action="<%=request.getContextPath()%>/main/searchPList"
					method="get" class="sidebar-form">
					<div class="input-group">
						<input type="text" id="keywordInput" name="keyword"
							class="form-control" placeholder="프로젝트명 검색"> <span
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<sec:authorize access="hasAuthority('ROLE_USER')">
						<li class="treeview"><a href="#"><i class="fa fa-link"></i>
								<span>계획설계</span> <span class="pull-right-container"> <i
							...
							<ul class="treeview-menu">
								<c:choose>
									<c:when test="${loginUser.id eq logonProject.creator }">
										<c:if test="${empty logonProject.puuid }">
											<li><a href="/plan/registerPlan"><i
													class="fa fa-circle-o"></i>프로젝트 계획서</a></li>
										</c:if>
										<c:if test="${!empty logonProject.puuid }">
											<li><a
												href="/plan/modifyPlan?puuid=${logonProject.puuid }"><i
													class="fa fa-circle-o"></i>프로젝트 계획서</a></li>
										</c:if>
									</c:when>
									<c:otherwise>
										<c:if test="${empty logonProject.puuid }">
											<li><a href="empty"><i class="fa fa-circle-o"></i>프로젝트
													계획서</a></li>
										</c:if>
										<c:if test="${!empty logonProject.puuid }">
											<li><a href="/plan/viewPlan" target="_blank"><i
													class="fa fa-circle-o"></i>프로젝트 계획서</a></li>
										</c:if>
									</c:otherwise>
								</c:choose>
								<c:choose>
									<c:when test="${loginUser.id eq logonProject.creator }">
										<c:if test="${logonProject.rdNum eq 0 }">
											<li><a href="/project/requirement/create"><i
													class="fa fa-circle-o"></i>요구사항 정의서</a></li>
										</c:if>
										<c:if test="${logonProject.rdNum ne 0 }">
											<li><a href="/project/requirement/list"><i
													class="fa fa-circle-o"></i>요구사항 정의서</a></li>
										</c:if>
									</c:when>
									<c:otherwise>
										<c:if test="${logonProject.rdNum eq 0 }">
											<li><a href="empty"><i class="fa fa-circle-o"></i>요구사항
													정의서</a></li>
										</c:if>
										<c:if test="${logonProject.rdNum ne 0 }">
											<li><a href="/project/requirement/list"><i
								...
								<li><a href="<%=request.getContextPath()%>/project/usecase"><i
										class="fa fa-circle-o"></i>use-case</a></li>
							</ul></li>

						<li class="treeview"><a href="#"><i class="fa fa-link"></i>
								<span>스마트 WIKI</span> <span class="pull-right-container">
						...
						<li><a
							href="<%=request.getContextPath() %>/project/listFinance?fNum=${logonProject.fNum}">
								<i class="fa fa-link"></i> <span>예산관리</span>
						</a></li>

						<li><a href="#"> <i class="fa fa-link"></i> <span>캘린더</span>
						</a></li>
						...
						<li class="treeview"><a href="#"><i class="fa fa-link"></i>
							...
							<ul class="treeview-menu">
								<li><a
									href="<%=request.getContextPath()%>/fileboard/fileboardlist"><i
										class="fa fa-circle-o"></i>자료실</a></li>
								<li><a href="<%=request.getContextPath()%>/notice/listPage"><i
										class="fa fa-circle-o"></i>공지사항</a></li>
								<li><a href="<%=request.getContextPath()%>/board/listPage"><i
										class="fa fa-circle-o"></i>자유게시판</a></li>
							</ul></li>


						<li><a
							href="<%=request.getContextPath()%>/project/issue/list"> <i
								class="fa fa-link"></i> <span>ISSUE</span>
						</a></li>
					</sec:authorize>

					<sec:authorize access="hasAuthority('ROLE_ADMIN')">
						<li class="treeview"><a href="#"><i class="fa fa-link"></i>
								<span>관리자 게시판</span> <span class="pull-right-container">
									<i class="fa fa-angle-left pull-right"></i>
							</span> </a>
							<ul class="treeview-menu">
								<li><a href="#"><i class="fa fa-circle-o"></i>공지사항</a></li>
								<li><a
									href="<%=request.getContextPath()%>/question/listQna"><i
										class="fa fa-circle-o"></i>QnA</a></li>
								<li><a
