...
<li>
  ...
  <c:if test="${loginUser.id eq logonProject.creator}">
	  <li class="treeview">
	    ...
	    <ul class="treeview-menu">
	      <li><a href="<%=request.getContextPath() %>/manage/memberList"><i class="fa fa-circle-o"></i>팀 관리</a></li>
	      <li><a href="<%=request.getContextPath() %>/manage/memberList"><i class="fa fa-circle-o"></i>신청 관리</a></li>
	      <li><a href="#"><i class="fa fa-circle-o"></i>프로젝트</a></li>
	    </ul>
	  </li>
  </c:if>
