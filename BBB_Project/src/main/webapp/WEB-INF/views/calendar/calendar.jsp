...
<!-- Slimscroll -->
<script src="<%= request.getContextPath() %>/resources/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="<%= request.getContextPath() %>/resources/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="<%= request.getContextPath() %>/resources/dist/js/adminlte.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<%= request.getContextPath() %>/resources/dist/js/demo.js"></script>
<!-- fullCalendar -->
<script src="<%= request.getContextPath() %>/resources/moment/moment.js"></script>
<script src="<%= request.getContextPath() %>/resources/fullcalendar/dist/fullcalendar.min.js"></script>
